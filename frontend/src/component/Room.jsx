...
function Room() {
    ...
    const handleShortBreakButtonClick = () => {
        setActive("short");
        setPaused(true);
        setMinCount(4);
        setCount(59);
    ...
    const handleLongBreakButtonClick = () => {
        setActive("long");
        setPaused(true);
        setMinCount(14);
        setCount(59);
        ...
        <div className="min-h-screen h-full w-full bg-[--medium] text-[--dark]">
            <div className="w-full h-16 flex justify-between px-10 items-center bg-[--light]">
                ...
                <div className="flex items-center gap-5">
                    <div id="time" className="text-xl font-bold">{`${minCount}:${count < 10 ? `0${count}` : count}`}</div>
                    <button id="focus" className={`btn  ${active === "focus" ? "btn-focus" : ""}`} onClick={handleFocusButtonClick}>Focus</button>
                    <button id="shortbreak" className={`btn ${active === "short" ? "btn-focus" : ""}`} onClick={handleShortBreakButtonClick}>Short Break</button>
                    <button id="longbreak" className={`btn ${active === "long" ? "btn-focus" : ""}`} onClick={handleLongBreakButtonClick}>Long Break</button>
                    <button id="btn-start" className={paused ? "show" : "hide"} onClick={handleStartButtonClick}>Start</button>
                    <button id="btn-pause" className={!paused ? "show" : "hide"} onClick={handlePauseButtonClick}>Pause</button>
                    <button id="btn-reset" className="hide" onClick={handleResetButtonClick}>Reset</button>
                </div>
            </div>
            <div className="p-10 flex items-start justify-center gap-10">
                <div className="flex w-[25%] h-full">
                ...
                <table className="w-[75%] p-2 text-center">
                    <thead className="bg-[--dark] text-[--light]">
                        <tr>
                            ...
                            <th className="w-40">Challenge Description</th>
                            <th>Mark as Done/Pending</th>
