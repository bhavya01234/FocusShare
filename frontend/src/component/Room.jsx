...
function Room() {
    ...
    return (
                ...
                <div className="flex w-[25%] h-full">
                    <div className="w-full m-4 flex flex-col items-center justify-center gap-4">
                        <form onSubmit={saveTask} className="flex flex-col gap-8">
                            <div className="text-5xl font-bold text-center text-white text-shadow">Create new To-do</div>
        ...
        <Link to="/chatroom" className="absolute m-3 rounded-full w-16 text-[--light] bg-[--dark] h-16 bottom-0 right-0 hover:bg-[#584e41] active:bg-[#494136] flex justify-center items-center text-3xl"><AiOutlineMessage/></Link>
